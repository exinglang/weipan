 ...
 * @author fanshuo
 */
public class ChengJiaoHistoryItemRVChild implements InterfaceRVEntity {
    MyApplication myapp;
    Context context;
    TradeReportDealData tradeDealData;

    public ChengJiaoHistoryItemRVChild(Context context, TradeReportDealData tradeDealData) {
...
//            }
//        });
        ((MyViewHolder)holder).tv_name.setText(tradeDealData.getCOMMODITY_NAME());
        ((MyViewHolder)holder).tv_time.setText(ActivityUtils.getRealData2(tradeDealData.getCLEAR_DATE()));
        ((MyViewHolder)holder).tv_chengjiaojiage.setText(tradeDealData.getPRICE());
        ((MyViewHolder)holder).tv_chengjiaoshuliang.setText(tradeDealData.getQUANTITY());
        ((MyViewHolder)holder).tv_shouxufei.setText(tradeDealData.getTRADE_FEE());
    }
