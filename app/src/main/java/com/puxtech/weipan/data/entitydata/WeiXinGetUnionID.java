...
public class WeiXinGetUnionID {
	...
	public WeiXinGetUnionID() {
		super();
	}
	public WeiXinGetUnionID(String openid, String nickname, int sex,
			String province, String city, String country, String headimgurl,
			String unionid, int errcode, String errmsg) {
		super();
		this.openid = openid;
