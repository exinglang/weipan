 ...
 */
public class CommodityListHorizontalScrollView extends HorizontalScrollView implements
        View.OnClickListener
{
    ...
    public CommodityListHorizontalScrollView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        // 获得屏幕宽度
...
//        }
     ...
     * @param mAdapter
     */
    public void setmAdapter(HorizontalScrollViewAdapter mAdapter,int clickPosition)
    {
...
//            mCountOneScreen = (mScreenWitdh / mChildWidth == 0)?mScreenWitdh / mChildWidth+1:mScreenWitdh / mChildWidth+2;
        ...
        //初始化第一屏幕的元素
        initFirstScreenChildren(mCountOneScreen,clickPosition);
    }
     ...
     */
    public void initFirstScreenChildren(int mCountOneScreen,int clickPosition)
    {
        mContainer = (LinearLayout) getChildAt(0);
