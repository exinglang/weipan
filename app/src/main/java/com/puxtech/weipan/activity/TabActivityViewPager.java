...
public class TabActivityViewPager extends BaseAppCompatActivity {
    ...
    public static final int MONIPAN = 2;
    public static final int HUODONG = 3;
    public static final int GEREN = 4;
...
//        setupFragments();
        ...
        fgList.add(tabHomeFragment);
        fgList.add(tabShiPanFragment);
        fgList.add(tabMoNiPanFragment);
        fgList.add(tabHuoDongFragment);
        fgList.add(tabGeRenFragment);
        String[]   TITLE = new String[]{"委托下单", "持仓明细", "成交明细", "模拟大赛","委托下单"};//标题
         adapter = new ShiPanFragmentViewPagerAdapter(fragmentManager, fgList, TITLE);
...
//       Fragment fragment= adapter.getItem(currentStepId);
        pager.setCurrentItem(currentStepId);
